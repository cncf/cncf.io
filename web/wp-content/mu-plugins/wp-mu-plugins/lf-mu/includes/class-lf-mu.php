...
class Lf_Mu {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'remove_image_sizes' );
		...
		$this->loader->add_filter( 'rest_pre_dispatch', $plugin_admin, 'restrict_users_endpoint', 9999, 3 );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'lfe_insert_lfx_head' );
