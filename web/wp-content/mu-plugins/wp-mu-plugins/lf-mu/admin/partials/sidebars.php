				...
				array(
					...
					'settings'     => array(
						...
						array(
							...
							'data_type'     => 'meta',
							'data_key'      => 'post_url',
							'label'         => __( 'External post url' ),
							'help'          => __( 'This will override the single post page for this person.' ),
							'register_meta' => true,
							'default_value' => '',
							'placeholder'   => 'https://www.cncf.io/blog/2024/06/20/kubestronaut-in-orbit-zhilong-wang/',
						),
					),
				),
			),
