				...
				array(
					...
					'settings'     => array(
						...
						array(
							...
							'help'          => __( 'An image used for the homepage banner ad. Recommended to use a square size at least 2400px x 840px.' ),
							'register_meta' => true,
							'ui_border_top' => true,
						),
						array(
							...
							'help'          => __( 'An image used for the homepage banner ad. Recommended to use a square size at least 900px x 1100px.' ),
							'register_meta' => true,
							'ui_border_top' => true,
						),
					),
