...
<footer class="footer">
	<div class="container wrap">
		<div class="footer-logo">
			<a href="/" title="<?php echo bloginfo( 'name' ); ?>">Home</a>
		</div>
		<div class="footer-align">
			...
			<div>Newsletter
				 ...
				 *  */
				?>
				<a href="#top"><svg aria-hidden="true" data-prefix="fas"
	...
	<div class="container wrap cred">
		<p>Copyright &copy; <?php echo bloginfo( 'name' ); ?>
			<?php echo esc_html( gmdate( 'Y' ) ); ?>. All
			rights reserved.</p>
	</div>
</footer>
<?php get_footer(); ?>
