<section>
    <div class="container wrap">
        ...
        <p>This sentence is <b>bold</b>. If you like semantics, you might go with
            ...
            <del>deleted</del>, or
            <mark>highlighted</mark>. You would use a <a href="#!">hyperlink</a> to go to
            a new
            page.</p>
        <p>If you like to write there are plenty of semantic tags for you. There's the
            <kbd>keyboard input</kbd>, <samp>computer
                output</samp>, and <var>variables</var>. </p>
        ...
        <blockquote>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam
            ...
            neque,
            harum minus, commodi laudantium quod excepturi nam corrupti odit provident.
...
public:
  ...
  static const string VOILA = "Voila";
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea delectus
            cupiditate
            minima, magni possimus commodi, eveniet? Rem, adipisci architecto pariatur
            libero
            aliquid culpa sunt accusantium. Ipsa error aliquid et! Animi.</p>
        <h2>Second Heading h2</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia molestias
            ullam
            quasi est a nemo, accusamus voluptatum autem. Eius explicabo est assumenda
            voluptatem
            id, hic maxime mollitia facere debitis quos.</p>
        <h3>Third Heading h3</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo deleniti,
            repudiandae
            rerum nam laborum eligendi aperiam. Autem id, ad necessitatibus accusantium,
            facilis,
            quae ullam est, voluptates debitis fugiat quos inventore!</p>
        <h4>Fourth Heading h4</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque cum eum
            eligendi
            voluptatum quasi nisi doloremque ipsam unde, laboriosam nihil voluptatem
            consequatur
            quam non similique vero ratione animi sit veritatis.</p>
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit voluptatem
            ...
            aut
            dolore
            magnam eligendi maiores expedita commodi perferendis non blanditiis.</p>
        ...
        <form lpformnum="1">
            ...
            <br />
            <a href="#"
               class="button">Link like Button</a>
        </form>
        ...
        <div class="entry-content"
             style="background-color: lightgrey; padding: 1em">
            <h2>Entry Content</h2>
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo deleniti,
                repudiandae
                rerum nam laborum eligendi aperiam. Autem id, ad necessitatibus
                accusantium,
                facilis,
                quae ullam est, voluptates debitis fugiat quos inventore!</p>
            <h4>Fourth Heading h4</h4>
            ...
            <h5>Fifth Heading h5</h5>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit voluptatem
                necessitatibus eos iusto nam deserunt, dicta possimus error qui
                reiciendis, aut
                dolore
                magnam eligendi maiores expedita commodi perferendis non blanditiis.</p>
