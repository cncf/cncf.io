...
<ul class="social-links">
	<?php if ( isset( $site_options['social_twitter'] ) ) : ?>
	...
	<?php if ( isset( $site_options['social_github'] ) ) : ?>
	...
	<?php if ( isset( $site_options['social_flickr'] ) ) : ?>
	...
	<?php if ( isset( $site_options['social_facebook'] ) ) : ?>
	...
	<?php if ( isset( $site_options['social_meetup'] ) ) : ?>
	...
	<?php if ( isset( $site_options['social_twitch'] ) ) : ?>
	...
	<?php if ( isset( $site_options['social_slack'] ) ) : ?>
