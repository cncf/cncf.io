...
<ul class="social-links">
	<?php if ( $site_options['social_twitter'] ) : ?>
	...
	<?php if ( $site_options['social_github'] ) : ?>
	...
	<?php if ( $site_options['social_linkedin'] ) : ?>
	...
	<?php if ( $site_options['social_wechat_id'] ) : ?>
	...
	<?php if ( $site_options['social_youtube'] ) : ?>
	...
	<?php if ( $site_options['social_flickr'] ) : ?>
	...
	<?php if ( $site_options['social_facebook'] ) : ?>
	...
	<?php if ( $site_options['social_meetup'] ) : ?>
	...
	<?php if ( $site_options['social_twitch'] ) : ?>
	...
	<?php if ( $site_options['social_slack'] ) : ?>
...
if ( $site_options['social_wechat_id'] ) :
	?>
	<!-- Modal -->
