...
<img aria-hidden="true" width="0" height="0" style="display:none !important;" src="<?php echo esc_url( get_template_directory_uri() . '/images/bg-cncf-pattern.png' ); ?>">

<section class="home-projects">
<div class="wp-block-group alignfull has-cncf-background-pattern">
