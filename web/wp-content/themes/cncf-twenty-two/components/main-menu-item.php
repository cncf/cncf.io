	...
	<div
		...
		<a href="<?php the_permalink(); ?>"
			...
			if ( has_post_thumbnail() ) {
				...
				Lf_Utils::display_responsive_images( get_post_thumbnail_id(), 'newsroom-200', '200px', 'main-menu-item__image', 'lazy', the_title_attribute() );
			} else {
				// show generic.
				$site_options  = get_option( 'lf-mu' );
				Lf_Utils::display_responsive_images( $site_options['generic_thumb_id'], 'newsroom-200', '200px', 'main-menu-item__image', 'lazy', the_title_attribute() );
			}
			?>
		</a>
	</div>
