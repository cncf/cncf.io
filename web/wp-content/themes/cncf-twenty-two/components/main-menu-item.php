...
<div class="main-menu-item">
	<div
		...
		<a href="<?php the_permalink(); ?>"
			...
			if ( has_post_thumbnail() ) {
				...
				Lf_Utils::display_responsive_images( get_post_thumbnail_id(), 'newsroom-200', '200px', 'main-menu-item__image' );
			} else {
				// show generic.
				$site_options  = get_option( 'lf-mu' );
				Lf_Utils::display_responsive_images( $site_options['generic_thumb_id'], 'newsroom-200', '200px', 'main-menu-item__image' );
			}
			?>
		</a>
	</div>
	<div class="main-menu-item__text-wrapper">
		...
		?>
		<a class="author-category" title="See more in <?php echo esc_attr( $category ); ?> category" href="<?php echo esc_url( $parent_link ); ?>">

		<?php
			echo esc_html( $category );
		?>
			 <?php echo esc_html( $type_of_post ); ?></a>
