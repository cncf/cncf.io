...
<div class="credits-pricing-wrapper">
	...
	<div class="eup-column col1">
		...
		<div class="tbody">
			<ul>
				<li><i class="fas fa-newspaper"></i>Coordinated CNCF press
					release</li>
				<li><i class="fas fa-certificate"></i>Appropriate placement on
					the CNCF website</li>
			</ul>
		</div>
		...
		<div class="tbody">
			<ul>
				<li><i class="fas fa-arrow-from-right"></i>Everything included
					in Supporter benefits, plus:</li>
				<li><i class="fab fa-youtube"></i>Bonus online program slot
					(live webinar, live stream, or on-demand webinar - your
					choice) to highlight your participation in the program</li>
				<li><i class="fas fa-cogs"></i>For Certified Kubernetes
	...
	<div class="eup-column col3">
		...
		<div class="tbody">
			<ul>
				<li><i class="fas fa-arrow-from-right"></i>Everything included
					in Advocate benefits, plus:</li>
				<li><i class="fas fa-certificate"></i>Top placement on the CNCF
					website with an explanation of the offering</li>
				<li><i class="fas fa-megaphone"></i>CNCF marketing campaign to
				...
				<li><i class="fas fa-users-cog"></i>CNCF will set up resource
