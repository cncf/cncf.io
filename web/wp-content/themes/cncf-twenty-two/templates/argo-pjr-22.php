...
// <?php LF_Utils::display_responsive_images( 78067, 'full', '1440px', false, 'lazy', 'alt' );
?>
	...
	<article class="container wrap">
		<section class="hero">
			...
			<div class="container wrap hero__container">
				...
				<img class="hero__logo"
					...
					width="309" height="135" alt="" loading="eager">
			...
			<div class="container wrap">
				...
				<div class="lf-grid">
					<div class="restrictive-column">
						...
						<h2 class="sub-header"><span
								class="orange-text">1.</span> Managing the Cloud
							Native
							Ecosystem</h2>
		...
		<section class="section-07">
			...
			<div class="lf-grid">
				<div class="restrictive-column">
					...
					<h2 class="sub-header"><span class="orange-text">2.</span>
						Multi-Cloud Availability</h2>
		...
		<section class="section-10 is-style-down-gradient alignfull">
			...
			<div class="container wrap">
				...
				<h2 class="sub-header"><span class="orange-text">Appendix
						A:</span> Summit Process</h2>
				...
				<h2 class="sub-header"><span class="orange-text">Appendix
						C:</span> Discussion Framework</h2>
			...
			<div class="container wrap">
				...
				<div class="lf-grid">
					<div class="restrictive-column">
						...
						<div class="author">
							<img src="<?php LF_utils::get_image( $report_folder . 'dr-udo-seidel.jpg' ); ?>"
								alt="Dr. Udo Seidel" width="200" height="200"
								loading="lazy" class="author__image">
