...
" alt="Building icon">
		...
		<section class="section-02 is-style-down-gradient alignfull">
			...
			<div class="container wrap">
				...
				<?php LF_Utils::display_responsive_images( 79066, 'full', '1440px', 'remove-bg', 'lazy', 'Chart showing upward cumulative growth of Argo Contributions by company from Q3 2017 - Q3 2022' ); ?>
				...
				<?php LF_Utils::display_responsive_images( 79067, 'full', '1440px', 'remove-bg', 'lazy', 'Chart showing upward Percentage breakdown of Argo Contributions by company from Q3 2017 - Q3 2022' ); ?>
				...
				<?php LF_Utils::display_responsive_images( 79068, 'full', '1440px', 'remove-bg restrict-image-width', 'lazy', 'Chart showing upward cumulative number of companies Q3 2017 - Q3 2022' ); ?>
				...
				<?php LF_Utils::display_responsive_images( 79069, 'full', '1440px', 'remove-bg restrict-image-width', 'lazy', 'Cumulative growth in contributors Q3 2017 - Q3 2022' ); ?>
		...
		<section class="section-04 is-style-down-gradient alignfull">
			...
			<div class="container wrap">
				...
				<?php LF_Utils::display_responsive_images( 79071, 'full', '1440px', 'remove-bg restrict-image-width', 'lazy', 'Chart showing upward monthly velocity of Argo project' ); ?>
				...
				<?php LF_Utils::display_responsive_images( 79072, 'full', '1440px', 'remove-bg restrict-image-width', 'lazy', 'Chart showing upward growth of Argo pull requests, code commits, issues, and authors over time' ); ?>
		...
		<section class="section-09 is-style-down-gradient alignfull">
			...
			<div class="container wrap">
				...
				<?php LF_Utils::display_responsive_images( 79073, 'full', '1440px', 'remove-bg restrict-image-width', 'lazy', 'Chart showing upward growth in participation in Argo project documentation from Q1 2017 - Q3 2022' ); ?>
				...
				<?php LF_Utils::display_responsive_images( 79074, 'full', '1440px', 'remove-bg restrict-image-width', 'lazy', 'Chart showing upward cumulative growth of Argo project documentation commits  from Q1 2017 - Q3 2022' ); ?>
			</div>
