...
<div class="events columns-three">
	...
	<div class="event-item">
		...
		<figure class="event-item__bg-figure">
			<?php
			LF_Utils::display_responsive_images( $background, 'event-380', '380px', 'event-item__bg-image', 'lazy', the_title_attribute() );
		...
		<div class="event-item__content">
			...
			<div>
				...
				<a href="<?php echo esc_url( $external_url ); ?>"
					...
					<?php
					LF_Utils::display_responsive_images( $logo, 'medium', '300px', 'event-item__logo', 'lazy', the_title_attribute() );
					?>
				</a>
				<?php else : ?>
