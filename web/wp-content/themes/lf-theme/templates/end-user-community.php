...
<main class="page-content end-user-page">
	<article class="container wrap entry-content">
		...
		if ( have_posts() ) :
			while ( have_posts() ) :
				...
				<h2 class="is-style-max-width-100">Join the vendor-neutral community of cloud native practitioners</h2>
				<!-- /wp:heading -->
  ...
  <g id="Group_143" data-name="Group 143" transform="translate(-261 -2185)">
	<rect id="Rectangle_107" data-name="Rectangle 107" width="100" height="100" rx="10" transform="translate(261 2185)" fill="#f0a"/>
	<path id="map-marker-alt-light" d="M29.625,14.813A14.813,14.813,0,1,0,44.438,29.625,14.829,14.829,0,0,0,29.625,14.813Zm0,24.688A9.875,9.875,0,1,1,39.5,29.625,9.886,9.886,0,0,1,29.625,39.5Zm0-39.5A29.625,29.625,0,0,0,0,29.625C0,41.57,4.161,44.905,26.58,77.406a3.7,3.7,0,0,0,6.089,0c22.419-32.5,26.58-35.837,26.58-47.781A29.625,29.625,0,0,0,29.625,0Zm0,73.126C8.132,42.044,4.938,39.576,4.938,29.625A24.687,24.687,0,0,1,47.082,12.168a24.526,24.526,0,0,1,7.231,17.457C54.313,39.576,51.12,42.041,29.625,73.126Z" transform="translate(280 2195)" fill="#fff"/>
  </g>
</svg>
				<!-- wp:spacer {"height":10} -->
  ...
  <g id="Group_73" data-name="Group 73" transform="translate(-1454.285 -2275)">
	...
	<path id="rocket-light" d="M65.107,2.494A2.259,2.259,0,0,0,63.516.9,47.345,47.345,0,0,0,52.743,0C39.368,0,31.319,7.1,25.3,16.5H12.223A6.78,6.78,0,0,0,6.7,19.914L.326,32.652A3.625,3.625,0,0,0,0,34.031a3.1,3.1,0,0,0,3.094,3.094H15.035l-1.366,2.761a4.275,4.275,0,0,0,.794,4.721l6.929,6.925a4.286,4.286,0,0,0,4.722.792l2.756-1.364V62.906A3.113,3.113,0,0,0,31.963,66a3.613,3.613,0,0,0,1.37-.326L46.06,59.307a6.76,6.76,0,0,0,3.416-5.525V40.7C58.859,34.668,66,26.587,66,13.277A46.629,46.629,0,0,0,65.107,2.494ZM4.762,33l5.62-11.241a2.275,2.275,0,0,1,1.841-1.134H23.205c-1.8,3.617-4.089,8.25-6.132,12.375ZM45.355,53.778a2.264,2.264,0,0,1-1.144,1.839L32.995,61.23V48.918c4.125-2.04,8.742-4.33,12.36-6.129ZM47.24,37.242c-5.092,2.55-17.517,8.693-22.935,11.374l-6.937-6.9c2.691-5.444,8.835-17.866,11.373-22.97,6.474-10.107,13.883-14.619,24-14.619a46.881,46.881,0,0,1,8.589.554,45.854,45.854,0,0,1,.54,8.6c0,10.065-4.512,17.463-14.632,23.966Zm.2-25.894a7.218,7.218,0,1,0,7.218,7.218A7.218,7.218,0,0,0,47.436,11.348Zm0,10.311a3.093,3.093,0,1,1,3.093-3.093,3.094,3.094,0,0,1-3.093,3.093Z" transform="translate(1471.756 2293)" fill="#fff"/>
				...
				<!-- /wp:spacer -->
								...
								<div class="wp-block-group alignfull has-blue-100-background-color has-background"><div class="wp-block-group__inner-container"><!-- wp:spacer {"height":80,"className":"is-style-80-responsive"} -->
				<div style="height:80px" aria-hidden="true" class="wp-block-spacer is-style-80-responsive"></div>
				<!-- /wp:spacer -->
				...
				<div class="wp-block-columns is-style-section-header-column"><!-- wp:column {"width":"90%","className":"bh-01"} -->
				<div class="wp-block-column bh-01" style="flex-basis:90%"><!-- wp:heading {"level":3,"placeholder":"Section header text","className":"is-style-max-width-100"} -->
				<h3 class="is-style-max-width-100">Latest news and insights from our end user community</h3>
				<!-- /wp:heading --></div>
				<!-- /wp:column -->

				<!-- wp:column {"width":"10%","className":"bh-02"} -->
				<div class="wp-block-column bh-02" style="flex-basis:10%"><!-- wp:heading {"level":6,"placeholder":"View all...","className":"is-style-add-chevron-after"} -->
				<h6 class="is-style-add-chevron-after"><a href="/blog">See all blog posts</a></h6>
				<!-- /wp:heading --></div>
				<!-- /wp:column --></div>
				<!-- /wp:columns -->
				...
				<!-- wp:columns {"className":"is-style-section-header-column"} -->
				<div class="wp-block-columns is-style-section-header-column"><!-- wp:column {"width":"70%","className":"bh-01"} -->
				<div class="wp-block-column bh-01" style="flex-basis:70%"><!-- wp:heading {"level":3,"placeholder":"Section header text"} -->
				<h3>Welcome to the newest CNCF end users</h3>
				<!-- /wp:heading --></div>
				<!-- /wp:column -->

				<!-- wp:column {"width":"30%","className":"bh-02"} -->
				<div class="wp-block-column bh-02" style="flex-basis:30%"><!-- wp:heading {"level":6,"placeholder":"View all...","className":"is-style-add-chevron-after"} -->
				<h6 class="is-style-add-chevron-after"><a rel="noreferrer noopener" href="https://landscape.cncf.io/card-mode?enduser=yes" target="_blank">See all end user members</a></h6>
				<!-- /wp:heading --></div>
				<!-- /wp:column --></div>
				<!-- /wp:columns -->
				...
				<div style="height:100px" aria-hidden="true" class="wp-block-spacer is-style-100-responsive"></div>
				<!-- /wp:spacer -->

				<!-- wp:group {"align":"full","backgroundColor":"tertiary-400","className":"is-style-default"} -->
				<div class="wp-block-group alignfull is-style-default has-tertiary-400-background-color has-background"><div class="wp-block-group__inner-container"><!-- wp:spacer {"className":"is-style-40-responsive"} -->
				...
				<h3 class="has-white-color has-text-color">End user representatives</h3>
				<!-- /wp:heading -->
...
<div class="social-modal-wrapper">
			<div class="people-social">
					<a href="https://www.linkedin.com/in/cheryljhung/" rel="noopener" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" aria-label="LinkedIn" role="img" viewBox="0 0 512 512" fill="currentColor"><title>LinkedIn</title>
...
<path fill="#FFF" d="M276 282c0-20 13-40 36-40 24 0 33 18 33 45v105h66V279c0-61-32-89-76-89-34 0-51 19-59 32" class="inner-color"></path>
							...
							<a href="https://twitter.com/oicheryl" target="_blank" rel="noopener"><svg xmlns="http://www.w3.org/2000/svg" aria-label="Twitter" role="img" viewBox="0 0 512 512"><title>Twitter</title><rect width="512" height="512" rx="15%" fill="currentColor"></rect><path class="inner-color" fill="#fff" d="M437 152a72 72 0 0 1-40 12 72 72 0 0 0 32-40 72 72 0 0 1-45 17 72 72 0 0 0-122 65 200 200 0 0 1-145-74 72 72 0 0 0 22 94 72 72 0 0 1-32-7 72 72 0 0 0 56 69 72 72 0 0 1-32 1 72 72 0 0 0 67 50 200 200 0 0 1-105 29 200 200 0 0 0 309-179 200 200 0 0 0 35-37"></path></svg></a>
							<a href="https://github.com/oicheryl" target="_blank" rel="noopener"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><title>Github</title><rect height="512" rx="15%" width="512" fill="currentColor"></rect><path class="inner-color" d="m335 499c14 0 12 17 12 17h-182s-2-17 12-17c13 0 16-6 16-12l-1-50c-71 16-86-28-86-28-12-30-28-37-28-37-24-16 1-16 1-16 26 2 40 26 40 26 22 39 59 28 74 22 2-17 9-28 16-35-57-6-116-28-116-126 0-28 10-51 26-69-3-6-11-32 3-67 0 0 21-7 70 26 42-12 86-12 128 0 49-33 70-26 70-26 14 35 6 61 3 67 16 18 26 41 26 69 0 98-60 120-117 126 10 8 18 24 18 48l-1 70c0 6 3 12 16 12z" fill="#fff"></path></svg></a>
						</div>
						<button data-modal-content-id="modal-51113" data-modal-prefix-class="lf" data-modal-close-text="Close" aria-label="Close" class="js-modal button smaller margin-top" id="label_modal_4" aria-haspopup="dialog">View profile</button>
		<!-- Modal -->
		<div class="modal-hide" id="modal-51113" aria-hidden="true">
...
<div class="people-box">
	<!-- thumbnail  -->
			<button data-modal-content-id="modal-58717" data-modal-prefix-class="lf" data-modal-close-text="Close" class="js-modal button-reset" aria-label="Close" id="label_modal_7" aria-haspopup="dialog">
		<div class="background-image-wrapper people-profile-picture">
	<figure class="background-image-figure">
	<img loading="lazy" class="" src="/wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-250x250.jpeg" srcset="/wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-250x250.jpeg 250w, /wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-300x300.jpeg 300w, /wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-150x150.jpeg 150w, /wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-200x200.jpeg 200w, /wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-170x170.jpeg 170w, /wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-270x270.jpeg 270w, /wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-340x340.jpeg 340w, /wp-content/uploads/2020/11/ELxkBsqUUAEmp0h-500x500.jpeg 500w, /wp-content/uploads/2020/11/ELxkBsqUUAEmp0h.jpeg 661w" sizes="(max-width: 400px) 100vw, 400px" alt="">	</figure>
	</div>
		</button>
		<!-- Name  -->
...
<div class="social-modal-wrapper">
			<div class="people-social">
					<a href="https://www.linkedin.com/in/katie-gamanji/" rel="noopener" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" aria-label="LinkedIn" role="img" viewBox="0 0 512 512" fill="currentColor"><title>LinkedIn</title>
<rect width="512" height="512" rx="15%" fill="currentColor"></rect>
<circle cx="142" cy="138" r="37" fill="#FFF" class="inner-color"></circle>
<path stroke="#FFF" stroke-width="66" d="M244 194v198M142 194v198" class="inner-color"></path>
<path fill="#FFF" d="M276 282c0-20 13-40 36-40 24 0 33 18 33 45v105h66V279c0-61-32-89-76-89-34 0-51 19-59 32" class="inner-color"></path>
						...
						<button data-modal-content-id="modal-58717" data-modal-prefix-class="lf" data-modal-close-text="Close" aria-label="Close" class="js-modal button smaller margin-top" id="label_modal_8" aria-haspopup="dialog">View profile</button>
		<!-- Modal -->
		<div class="modal-hide" id="modal-58717" aria-hidden="true">
			<div class="modal-content-wrapper">
				<div class="profile__header">
										<div class="background-image-wrapper people-profile-picture">
						<figure class="background-image-figure">
...
<div class="people-box">
	<!-- thumbnail  -->
			<button data-modal-content-id="modal-51812" data-modal-prefix-class="lf" data-modal-close-text="Close" class="js-modal button-reset" aria-label="Close" id="label_modal_1" aria-haspopup="dialog">
		<div class="background-image-wrapper people-profile-picture">
	<figure class="background-image-figure">
	<img loading="lazy" class="" src="/wp-content/uploads/2020/08/image-1-1-250x250.jpg" srcset="/wp-content/uploads/2020/08/image-1-1-250x250.jpg 250w, /wp-content/uploads/2020/08/image-1-1-300x300.jpg 300w, /wp-content/uploads/2020/08/image-1-1-150x150.jpg 150w, /wp-content/uploads/2020/08/image-1-1-200x200.jpg 200w, /wp-content/uploads/2020/08/image-1-1-170x170.jpg 170w, /wp-content/uploads/2020/08/image-1-1-270x270.jpg 270w, /wp-content/uploads/2020/08/image-1-1-340x340.jpg 340w, /wp-content/uploads/2020/08/image-1-1-500x500.jpg 500w, /wp-content/uploads/2020/08/image-1-1.jpg 690w" sizes="(max-width: 400px) 100vw, 400px" alt="">	</figure>
	</div>
		</button>
		<!-- Name  -->
...
<div class="social-modal-wrapper">
			<div class="people-social">
					<a href="https://www.linkedin.com/in/alena-prokharchyk-a7b28213/" rel="noopener" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" aria-label="LinkedIn" role="img" viewBox="0 0 512 512" fill="currentColor"><title>LinkedIn</title>
<rect width="512" height="512" rx="15%" fill="currentColor"></rect>
<circle cx="142" cy="138" r="37" fill="#FFF" class="inner-color"></circle>
<path stroke="#FFF" stroke-width="66" d="M244 194v198M142 194v198" class="inner-color"></path>
<path fill="#FFF" d="M276 282c0-20 13-40 36-40 24 0 33 18 33 45v105h66V279c0-61-32-89-76-89-34 0-51 19-59 32" class="inner-color"></path>
							...
							<a href="https://twitter.com/Lemonjet" target="_blank" rel="noopener"><svg xmlns="http://www.w3.org/2000/svg" aria-label="Twitter" role="img" viewBox="0 0 512 512"><title>Twitter</title><rect width="512" height="512" rx="15%" fill="currentColor"></rect><path class="inner-color" fill="#fff" d="M437 152a72 72 0 0 1-40 12 72 72 0 0 0 32-40 72 72 0 0 1-45 17 72 72 0 0 0-122 65 200 200 0 0 1-145-74 72 72 0 0 0 22 94 72 72 0 0 1-32-7 72 72 0 0 0 56 69 72 72 0 0 1-32 1 72 72 0 0 0 67 50 200 200 0 0 1-105 29 200 200 0 0 0 309-179 200 200 0 0 0 35-37"></path></svg></a>
							<a href="https://github.com/alena1108" target="_blank" rel="noopener"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><title>Github</title><rect height="512" rx="15%" width="512" fill="currentColor"></rect><path class="inner-color" d="m335 499c14 0 12 17 12 17h-182s-2-17 12-17c13 0 16-6 16-12l-1-50c-71 16-86-28-86-28-12-30-28-37-28-37-24-16 1-16 1-16 26 2 40 26 40 26 22 39 59 28 74 22 2-17 9-28 16-35-57-6-116-28-116-126 0-28 10-51 26-69-3-6-11-32 3-67 0 0 21-7 70 26 42-12 86-12 128 0 49-33 70-26 70-26 14 35 6 61 3 67 16 18 26 41 26 69 0 98-60 120-117 126 10 8 18 24 18 48l-1 70c0 6 3 12 16 12z" fill="#fff"></path></svg></a>
						</div>
						<button data-modal-content-id="modal-51812" data-modal-prefix-class="lf" data-modal-close-text="Close" aria-label="Close" class="js-modal button smaller margin-top" id="label_modal_2" aria-haspopup="dialog">View profile</button>
		<!-- Modal -->
		<div class="modal-hide" id="modal-51812" aria-hidden="true">
			<div class="modal-content-wrapper">
				<div class="profile__header">
										<div class="background-image-wrapper people-profile-picture">
						<figure class="background-image-figure">
