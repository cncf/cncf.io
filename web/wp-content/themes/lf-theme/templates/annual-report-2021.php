...
<main class="ar-2021">
	<article class="container wrap">
		<h3>WELCOME,<br>IT’S BEEN A YEAR<br>TO REMEMBER</h3>
		...
		<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula get dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate get, arcu. In enim justo, rhoncus ut imperdiet a.</p>
		<blockquote class="wp-block-quote is-style-max-width-800">
			<p>Inspirational quote Lorem ipsum dolor sit amet consectetuer adipiscing elit aenean commodo</p>
			<cite>John greenapples</cite>
		</blockquote>
		<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula get dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate get, arcu. In enim justo, rhoncus ut imperdiet a.</p>
		<div class="nav-el">
			<div class="nav-box">
				<a href="#who-we-are" class="box-link"></a>
				<img src="https://via.placeholder.com/44x44/d9d9d9/000000"
					alt="">
				<span>2021<br>
					momentum</span>
			</div>
			<div class="nav-box">
			<a href="#enduser-community" class="box-link"></a>
				<img src="https://via.placeholder.com/44x44/d9d9d9/000000"
					alt="">
				<span>CONFERENCES &<br>
					EVENTS</span>
		...
		>Cloud native technologies empower organizations to build and run scalable applications in modern, dynamic environments across public, private, and hybrid clouds. Containers, service meshes, microservices, immutable infrastructure, and declarative APIs exemplify the cloud native approach.</p>
		<p
		...
		<ul>
			<li><a href="https://www.cncf.io/certification/training/">Kubernetes
				...
				enrollments (65% increase from 2019).&nbsp;</li>
			<li><a href="https://www.cncf.io/certification/expert/">Certified
					Kubernetes Administrator (CKA) exam</a> hit 37,000
				enrollments (121% increase from 2019).</li>
			<li><a href="https://www.cncf.io/certification/ckad/">Certified
					Kubernetes Application Developer (CKAD)</a> hit 18,300 exam
				registrations (143% increase from 2019).&nbsp;</li>
			<li><a href="https://www.cncf.io/certification/kcsp/">Kubernetes
					Certified Service Provider (KCSP)</a> program reached 179
				certifications in 2020 (38% increase from 2019).</li>
			<li><a href="https://www.cncf.io/certification/training/">Kubernetes
					Training Partner (KTP)</a> program grew to 50 certified
				companies (40% increase from 2019).</li>
		</ul>
		<p
		...
		<p>Graduated projects are suitable for the vast majority of enterprises. Incubating projects are suitable for early adopters, and sandbox projects are suitable for innovators. Projects increase their maturity level by demonstrating to the TOC that they have attained end user and vendor adoption, established a healthy rate of code commits and codebase changes, and attracted committers from multiple organizations. </p>
		<div style="height:100px" aria-hidden="true" class="wp-block-spacer">
		</div>
