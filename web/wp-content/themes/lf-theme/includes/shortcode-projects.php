...
<div class="projects-wrapper">
		...
		while ( $project_query->have_posts() ) :
			...
			$date_accepted = get_post_meta( get_the_ID(), 'lf_project_date_accepted', true ) ? ' (accepted to CNCF on ' . date( 'm/d/Y', strtotime( get_post_meta( get_the_ID(), 'lf_project_date_accepted', true ) ) ) . ')' : '';
