...
<div
	...
	<div class="um-form">
		 ...
		 * ?>
			...
			* @input_vars
			* [{"var":"$args","type":"array","desc":"Profile form shortcode
			arguments"}]
			* @change_log
			* ["Since: 2.0"]
		...
		?>
			...
			<div
				class="um-profile-body <?php echo esc_attr( $nav . ' ' . $nav . '-' . $subnav ); ?>">
				...
				* @change_log
				* ["Since: 2.0"]
				* @usage add_action( 'um_profile_content_{$nav}_{$subnav}',
				'function_name', 10, 1 );
				* @example
				* <?php
