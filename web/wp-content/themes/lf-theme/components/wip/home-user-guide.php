...
<section class="user-guide">
			<div class="user-guide-wrapper">
				<div
					...
					<a href="/people/end-user-community/" class="box-link" title="Explore end user community"></a>
					<h2>End Users</h2>
				...
				<div
					...
					<a href="http://contribute.cncf.io/" class="box-link" title="Start contributing"></a>
					<h2>Contributors</h2>
				...
				<div
					...
					<a href="/about/join/" class="box-link" title="Become a member today"></a>
					<h2>Members</h2>
					<p>Build and shape the cloud native ecosystem and drive cross-company collaboration with more than 550 members.</p>
					<a href="/about/join/" class="arrow-cta has-white-color">Become a member today</a>
				</div>
			</div>
		</section>
