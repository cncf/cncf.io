...
<div class="<?php echo esc_attr( $media_classes ) ?>" <?php echo CTF_Display_Elements_Pro::get_available_images_attribute( $post ) ?>>
<?php
$num_added = 0;
foreach ( $media as $medium ) : ?>
    ...
    <?php endif; ?>
            ...
            <a href="<?php echo esc_url( $media_link ) ?>" class="<?php echo esc_attr( $media_link_classes ); ?>"<?php echo $media_link_att_string; ?>  target="_blank" rel="noopener noreferrer">
            <?php endif; ?>
