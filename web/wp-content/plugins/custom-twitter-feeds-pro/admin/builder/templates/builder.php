<div id="ctf-builder-app" class="ctf-fb-fs ctf-builder-app" :data-app-loaded="appLoaded ? 'true' : 'false'" :data-disable-pro="shouldDisableProFeatures ? 'true' : 'false'" 
:class="{'ctf-builder-app-lite-dismiss' : shouldDisableProFeatures == true && iscustomizerScreen, 'sw-feed-link-bar-present' : sw_feed, 'ctf-customizer-screen': iscustomizerScreen}"
>
	<?php
