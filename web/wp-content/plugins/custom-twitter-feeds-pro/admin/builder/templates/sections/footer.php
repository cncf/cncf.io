<div id="sb-footer-banner" class="ctf-fb-fs ctf-bld-footer" :class="(viewsActive.pageScreen == 'welcome' && feedsList != null && feedsList.length != 0) ? 'ctf-fb-full-wrapper' : 'ctf-fb-wrapper'" v-if="(!viewsActive.footerDiabledScreens.includes(viewsActive.pageScreen) || (viewsActive.pageScreen == 'welcome' && feedsList != null && feedsList.length != 0)) && !iscustomizerScreen">
	<div class="sb-box-shadow">
		...
		<div v-if="pluginType !== 'pro'" class="ctf-bld-ft-btm" v-html="mainFooterScreen.promo"></div>
	</div>
</div>
