   ...
   public static function global_enqueue_ressources_scripts($is_settings = false){
	...
	public static function get_social_wall_links() {
		return array(
			...
			'<a href="'. esc_url( admin_url( 'admin.php?page=ctf-oembeds-manager' ) ) . '">' . __( 'oEmbeds', 'custom-twitter-feeds' ) . '</a>',
			'<a href="'. esc_url( admin_url( 'admin.php?page=ctf-extensions-manager' ) ) . '">' . __( 'Extensions', 'custom-twitter-feeds' ) . '</a>',
