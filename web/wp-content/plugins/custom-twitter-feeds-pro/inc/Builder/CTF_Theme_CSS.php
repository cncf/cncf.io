...
class CTF_Theme_CSS {
	...
	const WRAP_SELECTOR = '.ctf-preview-ctn';
	...
	public function is_cached() {
		$stored_styles = get_option( 'ctf_theme_styles', array( 'file' => '', 'last_checked' => 0, 'styles' => array() ) );
	...
	public function cache() {
		...
		return update_option( 'ctf_theme_styles', $stored_styles, false );
	}
