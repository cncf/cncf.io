    ...
    function _connect()
    {
        ...
        if (!is_resource($this->fsock)) {
            ...
            if (!$this->fsock) {
                ...
                // We handle this exception higher in the stack and need an exception for custom error handling.
                throw new \Exception(rtrim("Cannot connect to $host. <br/><br/>Reason:<br/>Error $errno. $errstr <br/><br/>The SFTP server address is probably incorrect."));
